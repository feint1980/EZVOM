...
namespace Feintgine
{
	...
	public:
		...
		glm::mat4 getCameraMatrix(){ return _cameraMatrix; } // get camera's matrix
		glm::vec2 convertScreenToWorld(const glm::vec2 & screenCoords); // convert the pos of mouse in camera to current world
